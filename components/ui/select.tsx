...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-fit items-center justify-between gap-2 whitespace-nowrap rounded-md",
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        // HOVER BACKGROUND - This is the key addition
        "data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground",
        "hover:bg-accent hover:text-accent-foreground", // Fallback for browsers that don't support data-highlighted
